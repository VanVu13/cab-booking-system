...
// Status bar component with real time
function StatusBar() {
...
// Phone Frame wrapper – only shows on desktop (md+)
  ...
  return (
    <>
      {isMobile ? (
        ...
        <div className="flex h-screen items-center justify-center phone-desktop-bg overflow-hidden">
          <div
            className="relative phone-frame-outer"
            style={{
          ...
          >
            ...
            >
              ...
              {/* Home Indicator */}
              <div className="flex justify-center items-center pb-2 pt-1 bg-white flex-shrink-0">
